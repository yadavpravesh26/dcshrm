			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Job applications</h4> </div>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width:50px;">Resume</th>
	...
	<script>
	 ...
	 $(document).ready(function() {
		 $('#myTable').DataTable( {
			...
			"displayLength": 25,
			"ajax":{
				url :"jobs-applications-data.php", 
				type: "post",  
				"data": function ( data ) {
					data.job_id = <?php echo $_REQUEST['id'];?>;
					data.tpe =1;
				},
				complete: function() {
