	...
	if($xml->isSuccessful()){
		...
		$body = '<table>
					...
					<tr>
						...
						<td>'.$xml->paymentProfile->billTo->firstName.' '.$xml->paymentProfile->billTo->lastName.'</td>
					</tr>
					<tr>
						<td>'.$xml->paymentProfile->billTo->address.'</td>
						<td></td>
					</tr>
					<tr>
						<td>'.$xml->paymentProfile->billTo->city.'</td>
						<td></td>
					</tr>
					<tr>
						<td>'.$xml->paymentProfile->billTo->state.'</td>
						<td></td>
					</tr>
					<tr>
						<td>'.$xml->paymentProfile->billTo->zip.'</td>
						<td></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td>'.$xml->paymentProfile->billTo->phoneNumber.'</td>
						<td></td>
					</tr>
					<tr>
