...
switch($method)
{
	case 'add':
		...
		if($_POST['form1Name']!=''){
			...
			//$exits = $prop->getName('count(dept_id)', DEPARTMENT, " u_id=".$_POST['company']." AND dep_status=0 AND dep_name='".$_POST['form1Name']."'");
			//if($exits===0){
		...
		$change_url = (isset($_REQUEST['id'])?'industry.php?id='.$_REQUEST['id']:'industry.php');
...
.clps .checkbox label::before {
    border-radius: 50px;
}
.clp .checkbox label::before {
    border-radius: 30px;
}
</style>
</head>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						...
						?>
                           ...
                           <form data-toggle="validator" method="post" action="industry.php?method=<?php echo $foraction; ?>">
							<div class="white-box">
								<div class="row ">								
									<div class="col-sm-6">										<label class="form-label box-title">Industry Name</label>
								...
								<div class="row b-b clp" style="display: flex; align-items: center;">
									<div class="col-sm-2">
										<h4 class="m-b-0 box-title" >Category</h4>
									</div>
									<div class="col-sm-9">
