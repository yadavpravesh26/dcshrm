...
switch($method)
{
	...
	case 'update':
		...
		if($res)
		{
            ...
            setcookie("title", $msg, time()+10);
            setcookie("err", "error", time()+10);
			header('Location: action-hand-outs.php?method=modify&id='.$_REQUEST['id']);
		}
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title><?php echo $titleTag; ?> Hand outs</title>
	<!-- Bootstrap Core CSS -->
			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title"><?php echo $titleTag; ?> Hand outs</h4> </div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							<li><a href="dashboard.php">Dashboard</a>
							</li>
							<li class="active"><?php echo $titleTag; ?> Hand outs</li>
						</ol>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="white-box">
							<h3 class="box-title"><?php echo $titleTag; ?> Hand outs</h3>

							<?php $foraction = (isset($_REQUEST['id'])?'update&id='.$_REQUEST['id']:'add');?>

							<form data-toggle="validator" method="post" action="action-hand-outs.php?method=<?php echo $foraction; ?>" enctype="multipart/form-data" id='categoryform'>
								<div class="row">
                                    ...
                                    <div class="form-group col-md-4">
										...
										<div class="help-block with-errors"></div>
										<div class=""><?php 
										$old_name = "../images/docs/".$curr_val['doc_file'] ;
										$extension = end(explode('.',strtolower($old_name)));
										$new_name = "../images/docs/".$curr_val['doc_name'].".".$extension ;
										rename( $old_name, $new_name);
							
										echo ($curr_val['doc_file']!=''?'<a href="'.$new_name.'"><i class="ti-download"></i> '.$curr_val['doc_name'].'.'.$extension.' </a>':''); ?></div>
										</div>
									<div class="form-group col-md-4">
                                ...
                                <textarea id="mymce" name="document_content"><?php echo $curr_val['doc_content'];?></textarea>
									...
									<div class="clearfix"></div>
									<div class="col-sm-12">
										<a href="manage-hand-outs.php"><button type="button" class="btn btn-inverse waves-effect waves-light pull-right">Cancel</button></a>
