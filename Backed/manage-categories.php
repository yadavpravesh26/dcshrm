            ...
            <div class="container-fluid">
                <div class="row bg-title">
				 ...
				 <div class="row">
                  ...
                  <form data-toggle="validator" method="post" action="manage-categories.php?method=<?php echo $foraction; ?>"  >
                            ...
                            <h3 class="box-title">Manage Categories</h3> 
                             <div class="table-responsive dash-table">
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
									<?php 
							 $catsql = "SELECT  category_id,`category_name`,category_status from ".CATEGORY." WHERE `category_status`!='1' order by `category_id` Desc";
							...
							for($i=0; $i<count($catfet); $i++)
									...
									?>
                                        <tr>
                                            ...
                                            <td><a href="manage-categories.php?id=<?php echo $catfet[$i]['category_id'];?>&method=modify"><span class="label i-lable label-primary"><i class="i-font17 ti-pencil"></i></span></a> <a class="deleteone" id="<?php echo $catfet[$i]['category_id'];?>" href="javascript:void(0);"><span id="sa-delete" class="label i-lable label-danger "><i class="i-font17 ti-trash"></i></span></a></td>
                                        </tr>
										<?php } ?>
			...
			swal({   
				...
				if (isConfirm) {   
				 $.ajax({                     
							...
							url: "ajax.php",  
							cache:false,  
							data: 'ids='+del_id+'&meth=catdelete',  
							success: function(response)  
							{   
							  window.location.href = "manage-categories.php?method=dele";
							}   
						});              
				 } 
				 else 
