...
if(isset($_REQUEST['id'])){
	$titleTag = 'Edit';
	$curr_val = $prop->get('*',USERS, array('id'=>$_REQUEST['id'],'u_type'=>3));
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="white-box">
						 ...
						 <?php $foraction = ($_REQUEST['method']=='' || $_REQUEST['method']=='add')?'add':'update&id='.$_REQUEST['id'].'';?>
                             ...
                             <form data-toggle="validator" id="formadvertiser"  method="post" action="add-admin.php?method=<?php echo $foraction; ?>" >
                                       <div class="row">
