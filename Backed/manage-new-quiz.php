...
<head>
	...
	<title>Manage New B-Safe Program - DCSHRM Super Admin</title>
	<!-- Bootstrap Core CSS -->
...
<body>
			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Manage B-Safe Program</h4> </div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							<li><a href="javascript:void(0);">Dashboard</a>
							</li>
							<li class="active">Manage B-Safe Program</li>
						</ol>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
					<div class="col-md-12">
						   ...
						   <div class="white-box">
                            <h3 class="box-title">List Of B-Safe Program</h3>
 ...
 <div class="clearfix"></div>
								  <?php /* <ul class="icheck-list">
									   <li>Type:</li>
                                                <li>
																									<input type="hidden" value="" id="hidtyp">
                                                    <input type="checkbox" class="check re" name="typcheck[]" id="square-checkbox-1" data-checkbox="icheckbox_square-red" value="1">
                                                    <label for="square-checkbox-1">Document</label>
                                                </li>
                                                <li>
                                                    <input type="checkbox" class="check re" name="typcheck[]" id="square-checkbox-2" data-checkbox="icheckbox_square-red" value="2">
							   ...
							   <div class="clearfix"></div>
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center">B-Safe Program Title</th>
															 			...
															 			swal({
															 				...
															 				if (isConfirm) {
															 				 $.ajax({
															 							...
															 							{
															 							  window.location.href = "manage-new-quiz.php?method=dele";
															 							}
															 						});
															 				 }
															 				 else
