        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Manage Registrations</h3> 
                            <div class="table-responsive dash-table">
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
									<?php 
							 $catsql = "SELECT * from ".REGISTER." WHERE `r_status`!='2' order by `r_id` Desc";
							$catfet=$prop->getAll_Disp($catsql); 
							for($i=0; $i<count($catfet); $i++)
					                    {  
									?>
                                        <tr>
										 <td><?php echo $catfet[$i]['company_name'];?> </td>
                                            <td><?php echo $catfet[$i]['admin_name'];?> </td>
                                            <td><?php echo $catfet[$i]['admin_email'];?> </td>
