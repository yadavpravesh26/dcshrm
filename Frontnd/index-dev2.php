	...
	case 'login':
		...
		if(!empty($log) && $log['email']==$email && authenticateuser($password,$log['password']))
		{
			...
			if($log['status']===0 && $departLog['dep_status']===0){
				...
				header('Location:'.LIVE_SITE.'index.php'); break;

			}else{
				setcookie('err', 'Your Account Temporarily Blocked', time()+10);
				header('Location:'.LIVE_SITE.'index.php');
			}
		}
		else
		{
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-9 col-md-6 col-xs-12">
                ...
                <div class="sp-logo text-center">
                    ...
                    <hr>
                    <form class="form-horizontal login-form" data-toggle="validator" method="post" id="loginform" action="index.php?method=login">
                          ...
                          <div class="sp-component">
                            <div class="mt-15">
                              <button type="submit"  name="login" class="btn btn-danger sp-btn btn-block">Sign In</button>
										...
										<form style="display:none" class="form-horizontal forgot-form" data-toggle="validator" method="post" id="forgotform" action="index.php?method=forget">
                      <div style="text-align:center;" class="sp-content">
                      <?php
                          if($_COOKIE['err'] !='')
                          {
